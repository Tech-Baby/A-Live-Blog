      ...
      $sql = "SELECT * FROM categories ORDER BY id desc";
       if (isset($_GET["page"])) {
                      $Page = $_GET["page"];
                            ...
                            $sql = "SELECT * FROM categories ORDER BY id desc LIMIT $ShowPostFrom,3";
                            $stmt = $ConnectingDB->query($sql);

                           }

             else{$sql = "SELECT * FROM categories ORDER BY id desc LIMIT 0,3";
             $stmt = $ConnectingDB->query($sql);
                  }
     ...
     <nav>
       <ul class="pagination pagination-lg">
            ...
            <?php if (isset($Page)) { 
              ...
              <li class="page-item ">
              <a href="Categories.php?page=<?php echo $Page-1; ?>" class="page-link ">&raquo;</a></li>
           ...
           <?php
            ...
            for ($i=1; $i < $PostPagination; $i++) { 
              ...
              <a href="Categories.php?page=<?php echo $i; ?>" class="page-link "><?php echo $i; ?></a></li>
            <?php
            }else{ ?>
