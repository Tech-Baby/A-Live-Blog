...
if(isset($_POST["Submit"])){
 ...
 if (!empty($_FILES["Image"]["name"])) {
    $sql = "UPDATE post SET title='$PostTitle',categories='$Category' ,image='$Image',post='$PostText' WHERE id= '$SearchQueryParameter'";

 }else{
   $sql = "UPDATE post SET title='$PostTitle',categories='$Category',post='$PostText' WHERE id= '$SearchQueryParameter'";
 }
      ...
      <?php
       ...
       $stmt = $ConnectingDB ->query($sql);
         while ($Datarows=$stmt->fetch()) {
           ...
           $CategoryToBeUpdated = $Datarows['categories'];
