...
if(isset($_POST["Submit"])){
  ...
  if(empty($UserName)|| empty($Password)|| empty($ConfirmPassword)){
    ...
    $_SESSION["ErrorMessage"]= "Username Exist Already Try Another Name";
    Redirect_to("Admin.php");
  }else{
  global $ConnectingDB;
  $sql= "INSERT INTO admins(username,aname,password,addedby,datetime)";
  $sql .="VALUES(:userName,:aName,:password,:adminName,:dateTime)";
